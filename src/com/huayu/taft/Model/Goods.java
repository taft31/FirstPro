...
public class Goods {
    ...
    public Goods(String good_ID, String good_Batch, String good_Name, double good_Price, Date good_MadeTime, int good_ExpireTime, int good_SeeCount, int good_State) {
